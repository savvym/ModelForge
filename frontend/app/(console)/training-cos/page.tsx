...
import {
  getTrainingCosStatus,
  listTrainingCosEntries
...
export default async function TrainingCosRootPage() {
  return renderBrowser("");
}

export async function renderBrowser(prefix: string) {
    ...
    return (
      <div className="flex flex-col gap-4">
        ...
        <Alert>
          ...
          <AlertDescription>
            请先在「系统配置 → 训练环境 COS」中启用并填写 endpoint / bucket / SecretId / SecretKey。
          </AlertDescription>
        </Alert>
      </div>
    );
