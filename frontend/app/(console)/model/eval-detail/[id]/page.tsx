    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 xl:grid-cols-[minmax(0,1.15fr)_minmax(320px,0.85fr)]">
        <Card className="border-border bg-card/80 shadow-none">
          <CardHeader>
            <CardTitle className="text-base text-foreground">运行信息</CardTitle>
          </CardHeader>
        ...
        <Card className="border-border bg-card/80 shadow-none">
          <CardHeader>
            <CardTitle className="text-base text-foreground">结果概览</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            {groupedMetrics.length ? (
              <div className="space-y-2">
                <div className="text-xs uppercase tracking-[0.14em] text-muted-foreground">Group Metrics</div>
                <div className="grid gap-3">
      ...
      <Card className="border-border bg-card/80 shadow-none">
        <CardHeader className="gap-2">
          <CardTitle className="text-base text-foreground">运行项</CardTitle>
                ...
                {detail.items.map((item) => {
                  ...
                  return (
                    <TableRow key={item.id}>
                      ...
                      <TableCell className="max-w-[360px] break-all text-xs text-muted-foreground">
      ...
      <Card className="border-border bg-card/80 shadow-none">
        <CardHeader className="gap-2">
          <CardTitle className="text-base text-foreground">执行计划快照</CardTitle>
          <p className="text-sm text-muted-foreground">
...
function MetricCard({ metric }: { metric: EvaluationRunMetricV2 }) {
  return (
    <div className="rounded-lg border border-border bg-card/80 px-4 py-3">
      <div className="text-xs uppercase tracking-wide text-muted-foreground">{metric.metric_name}</div>
