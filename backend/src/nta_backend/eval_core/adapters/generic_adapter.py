...
class GenericBenchmark(DefaultDataAdapter):
    ...
    def _build_template_metric_kwargs(self) -> dict[str, Any]:
        ...
        from nta_backend.eval_core.template_utils import (
    ...
    def record_to_sample(self, record: dict[str, Any], line_number: int) -> Sample:
        ...
        if input_template:
            ...
            raw_input = _resolve_field(record, mapping, "input_field", "input_selector", _DEFAULT_INPUT_FIELD)

        raw_target = _resolve_field(record, mapping, "target_field", "target_selector", _DEFAULT_TARGET_FIELD)
