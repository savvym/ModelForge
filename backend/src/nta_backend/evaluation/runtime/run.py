...
from nta_backend.evaluation.runtime import evaluators, metrics, models
from nta_backend.evaluation.runtime.adapters import (
    generic_adapter as _generic,  # noqa: F401 — registers _generic
)
from nta_backend.evaluation.runtime.api.registry import create_evaluator, get_benchmark, get_model
